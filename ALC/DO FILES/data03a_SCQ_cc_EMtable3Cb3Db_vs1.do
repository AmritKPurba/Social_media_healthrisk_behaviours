...
*Do file: data03a_SCQ_cc_EMtable3Cb3Db_vs1
*Dataset used: data01_SCQ_cc_alc.dta
*Amrit Purba 26.1.23

/* Syntax for SCQ complete case analysis: Multiplicative measure of effect modification - Poisson regression with robust standard errors (RR high PE/RR low PE) [3Cb]
