...
*Do file:data03a_SCQ_cc_EMtable3Ca3Da_vs1
*Dataset used: data01_SCQ_cc_alc.dta
*Amrit Purba 26.01.2023

/* Syntax for SCQ complete case analysis: Additive measure of effect modification - Linear regression with robust standard errors (RD high PE-low PE) [3Ca]
