...
*Do file: data03b_TUD_cc_EMtable4Cb4Db_vs1
*Dataset used: data01_TUD_cc_alc.dta
*Amrit Purba 26.1.23

/* Syntax for TUD complete case analysis: Multiplicative measure of effect modification - Poisson regression with robust standard errors (RR high PE/RR low PE) [4Cb]
