...
*Do file:data03a_SCQ_imp_EMtable3Aa3Ba_vs1
*Dataset used: data01_master_vs3_SCQ_imp_4_2.dta
*Amrit Purba 25.1.23

/* Syntax for SCQ imputed analysis: Additive measure of effect modification - Linear regression with robust standard errors (RD high PE-low PE) [3Aa]
