...
*Do file:data03a_data03a_TUD_imp_EMtable4Aa4Ba_vs1
*Dataset used: data01_master_vs3_TUD_imp_3_2.dta
*Amrit Purba 25.01.2023

/* Syntax for TUD imputed analysis: Additive measure of effect modification - Linear regression with robust standard errors (RD high PE-low PE) [4Aa]
Additive measure of interaction - Linear regression with robust standard errors (RD11-(RD10+RD01)) [4Ba] */
...
*A4: 
mi estimate, esampvaryok: svy: regress everbingedrink_rBcc_imp A4smscq##hied_COB_imp , baselevel
*mi estimate, esampvaryok: svy: regress everbingedrink_rBcc_imp avgsm_tud_5Cimp##hied_COB_imp , baselevel
...
*R10 (p10-p00): RD for low parental education and 1-<30mins SM use
*R01 (p01-p00): RD for high parental education and no SM use
*Calculation: R11-(R01+R10) */tal education and no SM use
*Calculation: R11-(R01+R10) */
