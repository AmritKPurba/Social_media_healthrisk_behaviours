********************************************************************************
*# Self-report imputed multiplicative effect modification & interaction analysis: social media > binge drinking 
********************************************************************************
...
Syntax: 
Multiplicative measure of effect modification - Poisson regression with robust standard errors (RR high PE/RR low PE) [3Ab]
Multiplicative measures of interaction - Poission regression with robust standard errors (RR11/RR10*RR01) [3Bb]
 */
...
use "Social_media_alcohol\DATASETS\data01_master_vs3_SCQ_imp_4_2.dta", clear
set seed 574367
