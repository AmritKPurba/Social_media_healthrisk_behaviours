********************************************************************************
*# Time use diary complete case multiplicative effect modification & interaction analysis: social media > binge drinking
********************************************************************************
...
Syntax: 
Multiplicative measure of effect modification - Poisson regression with robust standard errors (RR high PE/RR low PE) [4Cb]
Multiplicative measures of interaction - Poission regression with robust standard errors (RR11/RR10*RR01) [4Db]
 */
...
tab everbingedrink_rBcc avgsm_tud_r5Ccc if hied_COBcc==1 // high par ed 
tab everbingedrink_rBcc avgsm_tud_r5Ccc if hied_COBcc==0 // low par ed 
