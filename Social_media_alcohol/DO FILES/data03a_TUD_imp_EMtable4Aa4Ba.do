...
*# Time use diary imputed additive effect modification & interaction analysis: social media > binge drinking 
********************************************************************************
...
Syntax: 
Additive measure of effect modification - Linear regression with robust standard errors (RD high PE-low PE) [4Aa]
