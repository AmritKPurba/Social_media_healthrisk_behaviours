********************************************************************************
*# Self-report complete case additive effect modification & interaction analysis: social media > binge drinking 
********************************************************************************
...
Syntax: 
Additive measure of effect modification - Linear regression with robust standard errors (RD high PE-low PE) [3Ca]
Additive measure of interaction - Linear regression with robust standard errors (RD11-(RD10+RD01)) [3Da] 
*/
...
*Identify reference category to be used in EM and interaction analysis [C] Considering both exposure and EM jointly identify the stratum with the lowest risk of ever binge drinking which will become our reference category: low parental education and no SM use (as per- Estimating measures of interaction on an additive scale for preventive exposures)
svyset [pweight=GOVWT2], strata(PTTYPE2) psu(SPTN00) fpc(NH2) 
svy: logit everbingedrink_rBcc ib2.smscq_r5Ccc#i.hied_COBcc, or baselevel
logit everbingedrink_rBcc ib2.smscq_r5Ccc#i.hied_COBcc, or baselevel
...
*A4: 
svy: regress everbingedrink_rBcc A4smscq##hied_COBcc , baselevel
*svy: regress everbingedrink_rBcc smscq_r5Ccc##hied_COBcc , baselevel
