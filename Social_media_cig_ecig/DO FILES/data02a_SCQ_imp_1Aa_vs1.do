********************************************************************************
//Self-report imputed analysis: social media > cigarette use SAP SAP 1Aa, 1Ca, 1Da, 1Ea, 1Fa, 1Ga analyses
********************************************************************************
/*
...
Syntax:
	1Aa: Social media and cigarette use - logistic regression  
	1Ca: additional adjustment for cigarette use (age 14) 
	1Da: additional adjustment for previous social media use (age 11)
	1Ea: use of 4-category social media variable + 3-category outcome variable  
	1Fa: change of ref cat to 'no social media use' 
	1Ga: by sex 
