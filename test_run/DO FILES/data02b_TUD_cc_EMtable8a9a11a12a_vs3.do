...
*Do file: data02b_TUD_cc_EMtable8a9a11a12a_vs3 (using updated weight)
...
*Table 8A: Approach 2- Modification of the effect of social media use on CM e-cigarette use, by parental education (n=2109) (SAP 4Ca)
...
*Table 9A: Approach 1 & 2 - Modification of the effect of social media use on CM e-cigarette use, by parental education (n=2109) (SAP 4Ca)
...
*Table 11a: Approach 2 - Interaction between social media use and parental education on the risk of CM e-cigarette use  (n=2109) (SAP 4Da)
...
*Table 12A: Approach 1 & 2- Interaction between social media use and parental education on the risk of CM e-cigarette use  (n=2109) (SAP 4Da)
