...
*Do file: data02a_SCQ_cc_EMtable2a_vs1
...
*Table 2a: Approach 2- Modification of the effect of social media use on CM cigarette use, by parental education (n=6234) (SAP 3Ca)
...
contrast p.smscq_r5Ccc@hied_COBcc, noeffects 
*0_high parental ed = 0.0000 - significant linear relationship - risk of smoking in high parental education group increases as time spent on SM increases, which aligns with our RRs
*1_low parentel ed = 0.1678 - no significant linear relationship - risk of smoking in low par ed group does not increase as time spent on SM increases, which aligns with our RRs. Non significant test could be a result of low sample size in low parental education group.
