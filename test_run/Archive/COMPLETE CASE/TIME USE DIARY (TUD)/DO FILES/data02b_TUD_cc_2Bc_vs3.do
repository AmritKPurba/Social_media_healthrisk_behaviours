...
********************************************************************************
//TUD complete case analysis: SAP 2Bc
********************************************************************************

// data02b_TUD_cc_2Bc_vs3.do: Syntax for SAP 2Bc analysis (using updated weight)
// Amrit Purba 29.11.22

*Syntax for SAP 2Bc 
*Exposure- avgsm_tud_r5Ccc  
*Outcome- Cigarette and e-cigarette use (composite)
...
* Unweighted
tab avgsm_tud_r5Ccc cigecig_COcc, row col

* Weighted (TUD non response and survey design weights)
svyset [pw = TUD_WT_RO1] , strata(PTTYPE2) psu(SPTN00) fpc (NH2)
svy: tab avgsm_tud_r5Ccc cigecig_COcc, row per ci
svy: tab avgsm_tud_r5Ccc cigecig_COcc, count
...
* Unweighted
mlogit cigecig_COcc ib2.avgsm_tud_r5Ccc, rrr baselevel

* Weighted model (TUD non response and survey design weights)
svyset [pw = TUD_WT_RO1] , strata(PTTYPE2) psu(SPTN00) fpc (NH2)
svy: mlogit cigecig_COcc ib2.avgsm_tud_r5Ccc, rrr baselevel
...
* Unweighted
mlogit cigecig_COcc ib2.avgsm_tud_r5Ccc i.eth_rBcc i.famstr_r3Ccc ib5.hhinc_r5Ccc i.hied_CO7Ccc ib6.hiocc_CO6Ccc i.sex_rBcc i.parcursmk_CO2Ccc i.parstyCOcc i.prvcig_rBcc i.anti_COccim i.prvalc_rBcc i.urb_COcc  i.cmage6_3Ccc i.sibshh_5Ccc i.mag12_r4Ccc avg_inpact_COcc cogab_rcc sdqtotal_rnimpcc risk_rcc i.eng_D i.wales_D i.scot_D ib10.imd_COcc, rrr baselevel

* Weighted model (TUD non response and survey design weights)
svyset [pw = TUD_WT_RO1] , strata(PTTYPE2) psu(SPTN00) fpc (NH2)
svy: mlogit cigecig_COcc ib2.avgsm_tud_r5Ccc i.eth_rBcc i.famstr_r3Ccc ib5.hhinc_r5Ccc i.hied_CO7Ccc ib6.hiocc_CO6Ccc i.sex_rBcc i.parcursmk_CO2Ccc i.parstyCOcc i.prvcig_rBcc i.anti_COccim i.prvalc_rBcc i.urb_COcc  i.cmage6_3Ccc i.sibshh_5Ccc i.mag12_r4Ccc avg_inpact_COcc cogab_rcc sdqtotal_rnimpcc risk_rcc i.eng_D i.wales_D i.scot_D ib10.imd_COcc, rrr baselevel
