...
use "IMPUTED\TIME USE DIARY (TUD)\DATASETS\data01_master_vs3_TUD_imp_3_1.dta", clear

set seed 9260589

* Should say (data unchanged since 01dec2022 09:59)
...
*Model does not converge troubleshoot- problem var smok6_r5Ccc
...
*Collapse smok6_r5Ccc
codebook smok6_r5Ccc
mi passive: gen smok6_rBcc = .
mi passive: replace smok6_rBcc =0 if smok6_r5Ccc==1  | smok6_r5Ccc==2
mi passive: replace smok6_rBcc =1 if smok6_r5Ccc==3  | smok6_r5Ccc==4 | smok6_r5Ccc==5
label define smok6_rBcc 0"0_never_or_tried_cig" 1"1_current_former_cig"
label values smok6_rBcc smok6_rBcc
mi xeq: tab smok6_rBcc smok6_r5Ccc
*Run the weighted model using the logit command (obtaining RRRs)- 1-<30 mins SM use as ref cat- adjustment. Using smok6_rBcc.
mi est, rrr: svy: mlogit  cigecig_CO_imp ib2.avgsm_tud_5Cimp i.eth_rBcc  i.famstr_r3Ccc  ib5.hhinc_r5Ccc i.hied_COB_imp  ib6.hiocc_CO6Cim i.sex_rBcc  i.parcursmk_CO2Cim i.parstyCOcc i.prvcig_rBcc  i.anti_COccim i.prvalc_rBcc i.urb_COcc  i.cmage6_3Ccc  i.sibshh_4Cimp mag12_rcc avg_inpact_COcc cogab_rcc sdqtotal_rnimpcc risk_rcc i.eng_D_imp i.wales_D_imp i.scot_D_imp  ib10.imd_COcc i.ecig6_r4Ccc i.smok6_rBcc , baselevel 
...
* Run the weighted model using the logit command (obtaining RRRs)- 1-<30 mins SM use as ref cat- adjustment 
mi est, rrr: svy: mlogit  cigecig_CO_imp ib2.smwkdaytud_r5Ccc i.eth_rBcc  i.famstr_r3Ccc  ib5.hhinc_r5Ccc i.hied_COB_imp  ib6.hiocc_CO6Cim i.sex_rBcc  i.parcursmk_CO2Cim i.parstyCOcc i.prvcig_rBcc  i.anti_COccim i.prvalc_rBcc i.urb_COcc  i.cmage6_3Ccc  i.sibshh_4Cimp mag12_rcc avg_inpact_COcc cogab_rcc sdqtotal_rnimpcc risk_rcc i.eng_D_imp i.wales_D_imp i.scot_D_imp  ib10.imd_COcc,  baselevel 
