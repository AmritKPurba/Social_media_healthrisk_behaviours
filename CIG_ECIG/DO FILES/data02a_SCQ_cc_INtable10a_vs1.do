...
*Do file: data02a_SCQ_cc_INtable10a_vs1
...
*Table 10a: Approach 1-  Interaction between social media use and parental education on the risk of CM e-cigarette use  (n=6234) (SAP 3Db)
...
* coeff = 0.0532261, as we move from no SM use through each of the SM time categories (one step increase in category) our risk of outcome increases by .0531689 . Thus a one step increase in SM category has a linear relationship with increased smoking, whilst controlling for the effect of parental education
...
*1_low parentel ed = 0.0122 - significant linear relationship - risk of e-cigarette use in low par ed group increases as time spent on SM increases
********************************************************************************
